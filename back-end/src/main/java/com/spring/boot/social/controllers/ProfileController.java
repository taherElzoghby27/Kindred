...
public class ProfileController {
    ...
    @PutMapping
    public ResponseEntity<SuccessDto<AccountDto>> updateAccount(@Valid @RequestBody AccountDto accountDto) {
        return ResponseEntity.ok(new SuccessDto<>(profileService.updateProfile(accountDto)));
    }
}
